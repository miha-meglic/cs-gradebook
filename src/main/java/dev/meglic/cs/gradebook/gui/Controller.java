...
public class Controller {
	...
	public void initialize () {
		...
		if (!database.exists()) {
			...
			alert.setContentText("Na konfigurirani lokaciji baza (�e) ne obstaja,\nzato jo bomo ponovno postavili.");
			alert.showAndWait();
	...
	private Pair<String, Boolean> getDBLocationDialog () {
		...
		dialog.setHeaderText("Dolo�i lokacijo podatkovne baze");
		...
		ButtonType cancel = new ButtonType("Prekli�i", ButtonBar.ButtonData.CANCEL_CLOSE);
		...
		CheckBox cbNew = new CheckBox("Ustvari novo bazo (pobri�e obstoje�o datoteko)");
